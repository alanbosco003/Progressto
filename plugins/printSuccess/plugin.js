...
module.exports = {
	async apply(value, previousValues) {
		return new Promise(resolve => {
			console.log('\n');
			console.log(
				'TheCodingMachine React-Native Progressto initialized with success ! 🚀\n'
			);
			console.log(
				`${green(
					'                                                                    .-`    `::  \n' +
			...
			console.log(
				'- 📚 If you need to read more about this progressto : https://thecodingmachine.github.io/react-native-progressto/'
			);
			console.log(
				'- 🤕 If you have some troubles : https://github.com/thecodingmachine/react-native-progressto/issues'
			);
			console.log(
				'- ⭐ If you love this progressto, give us a star, you will be a ray of sunshine in our lives :) https://github.com/thecodingmachine/react-native-progressto'
			);
